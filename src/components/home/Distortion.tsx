...
// Distortion Effects
const mountainDistortion: DistortionEffect = {
...
const xyDistortion: DistortionEffect = {
  uniforms: xyUniforms,
  getDistortion: `
    uniform vec2 uFreq;
    uniform vec2 uAmp;
...
const LongRaceDistortion: DistortionEffect = {
...
const turbulentDistortion: DistortionEffect = {
...
const turbulentDistortionStill: DistortionEffect = {
  uniforms: turbulentUniforms,
  getDistortion: `
    uniform vec4 uFreq;
    uniform vec4 uAmp;
...
const deepDistortion: DistortionEffect = {
...
const deepDistortionStill: DistortionEffect = {
  uniforms: deepUniforms,
  getDistortion: `
    uniform vec4 uFreq;
    uniform vec4 uAmp;
...
// Main Component
const Distortion: React.FC<DistortionProps> = ({ containerRef }) => {
  return null;
};

export default Distortion;
export { deepDistortion };