...
import { solutionsHeading, baseMediaUrl } from '@/constants/data';
  ...
  return (
    <section className="w-full inset-0">
      ...
      >
        ...
        <SectionText
          title={data?.title || solutionsHeading.title}
          subtitle={data?.subtitle || solutionsHeading.subtitle}
          description={data?.description || solutionsHeading.description}
        ...
        />
        <SectionImage 
          src={`${baseMediaUrl}/images/pages/solutions/solutions-2.png`}
