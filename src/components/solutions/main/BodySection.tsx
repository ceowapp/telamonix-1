...
import { solutionsList, imageFallbackUrl } from '@/constants/data';
import { solutionsRoutes } from '@/constants/routes';
...
const FallbackComponent = React.memo(({  
  ...
  const localeRoute = getSlugByLanguage(solutionsRoutes, language);
  const solutions = React.useMemo(
    () => (Array.isArray(data?.sectionjson) ? data.sectionjson : solutionsList),
    [data?.sectionjson]
  );
    ...
    <section className="w-full py-8 sm:py-12 md:py-16 lg:py-24 px-4 sm:px-8 md:px-12 lg:px-16 xl:px-20">
      <div className="w-full mx-auto">
        <div className="flex items-center justify-center mb-4 sm:mb-8 px-4">
          <div className="w-full md:min-h-[60px] max-w-3xl mx-auto mb-6 sm:mb-8 md:mb-12 text-center px-4">
                ...
                >
                  ...
                  >
                    <Card
                      ...
                      titleClassName="text-title-medium-black-3 ml-4 mb-0"
